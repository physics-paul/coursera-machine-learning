...
init_cost = round(cost(X[:5,:3],T[:4,:3],Y[:5,:4],R[:5,:4]),2)

### output #################################################

print('   ex8 : 2. Recommender Systems')
print('   Initial unregularized cost = {}'.format(init_cost))
...
init_reg_cost = round(cost(X[:5,:3],T[:4,:3],Y[:5,:4],R[:5,:4],1.5),2)

### output #################################################

print('   Initial regularized cost = {}'.format(init_reg_cost))
print('')
